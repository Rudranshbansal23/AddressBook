...
class Contact {
	 ...
	 * difference between class name variable and constructur name variable because
...
public class AddressBookSystem {
	...
	public static void main(String[] args) {
		 ...
		 */
		Contact details = new Contact("Ashish", "Sahu", "BBSR, Bolangir", "Odisha", "Odisha", "abc@gmail.com", 764349,
				7922493164L);
