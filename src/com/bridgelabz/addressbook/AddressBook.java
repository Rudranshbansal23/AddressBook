...
/**
 * Purpose - Ability to Read or Write the Address Book with Persons Contact into
 * a File using File IO
 * 
 * @author - ASHISH SAHU
 */
...
public class AddressBook {
	...
	public static void sortByOption() {
		...
		case 4:
			...
			break;
		case 5:
			AddressBook.sortByZip(Contact::getZipCode).forEach(System.out::println);
			break;
		default:
			System.out.println("Please enter a valid choice");
		}
